    ...
    <div v-show="showFlag" class="food" ref="food">
      <div class="food-content">
        <div class="image-header">
          <img :src="food.image" alt="imgHeader">
        ...
        <div class="content">
          ...
          <div class="cart-control-wrapper">
            <CartControl :food="food" @addFood="addFood"></CartControl>
          </div>
        ...
        <div class="rating">
          ...
          <RatingSelect @ratingTypeSelect="ratingTypeSelect" @contentToggle="contentToggle" :selectType="selectType" :onlyContent="onlyContent" :desc="desc" :ratings="food.ratings" ref="test"></RatingSelect>
          <div class="rating-wrapper">
            <ul v-show="food.ratings && food.ratings.length">
              <li v-show="needShow(rating.rateType, rating.text)" v-for="(rating,index) in food.ratings" :key="index" class="rating-item border-1px">
                ...
                <div class="time">{{rating.rateTime | format_Date}}</div>
                <p class="text">
