...
<template>
  <div class="ratings" ref="ratings">
    <div class="ratings-content">
      ...
      <Split></Split>
      <RatingSelect @ratingTypeSelect="ratingTypeSelect" @contentToggle="contentToggle" :selectType="selectType" :onlyContent="onlyContent" :desc="desc" :ratings="ratings" ref="test"></RatingSelect>
